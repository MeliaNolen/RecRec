...
$(document).on("click", ".submitButton", function () {
    ...
    //still needs to be coded to match day selection *****************************************
    var selectedDay = $('.selectedDay').text(moment().format('MMMM Do'));
